          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Total Request</p>
                <h4 class="mb-0">{{$totalRequest}}</h4>
              </div>
            </div>
        ...
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Pending Request</p>
                <h4 class="mb-0">{{$pendingRequest}}</h4>
              </div>
            </div>
            <!-- <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
        ...
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Closed Request</p>
                <h4 class="mb-0">{{$closedRequest}}</h4>
              </div>
            </div>
            <!-- <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6>Latest Recruitment Request:</h6>
